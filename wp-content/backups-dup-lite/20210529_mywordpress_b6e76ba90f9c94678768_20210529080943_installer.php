...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210529_mywordpress_b6e76ba90f9c94678768_20210529080943_archive.zip';
	const ARCHIVE_SIZE		 = '50077911';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b6e76ba-29080943';
    const SECONDARY_PACKAGE_HASH = '2be572b-29080943';
	const VERSION			 = '1.4.1';
